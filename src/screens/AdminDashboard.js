...
export default function AdminDashboard({ navigation }) {
  ...
  const quickActions = [
    ...
    },
    {
      ...
      description: "Assign routes and track drivers",
      icon: "🚛",
      action: "drivers",
    },
    {
    ...
    },
    {
      id: 5,
      title: "Waste Reports",
      description: "Review waste collection data",
      icon: "📋",
      action: "reports",
    },
    {
      ...
      description: "Monitor ongoing collections",
      icon: "📍",
      action: "tracking",
    },
    {
    ...
    },
    {
      ...
      description: "Waste identification tool",
      icon: "📱",
      action: "scanner",
    },
    {
